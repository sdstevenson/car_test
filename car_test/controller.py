...
def monitor_controller():
    ...
    left_motor = motors.ThreePinMotor(forward_pin=11, backward_pin=13, speed_pin=32)
    right_motor = motors.ThreePinMotor(forward_pin=15, backward_pin=16, speed_pin=33)
